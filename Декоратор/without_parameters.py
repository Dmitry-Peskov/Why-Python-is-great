...
if __name__ == "__main__":
    ...
    # 27.04.2024 21:27:56 вызов test_func() с args () и kwargs {'a': 10, 'b': 4, 'c': 15} дал результат 48.5
    # 27.04.2024 21:27:56 вызов test_func() с args (3, 7, 11) и kwargs {} дал результат 55.5
    # 27.04.2024 21:27:56 вызов test_func() с args (3, 6) и kwargs {'c': 12} дал результат 42.0
